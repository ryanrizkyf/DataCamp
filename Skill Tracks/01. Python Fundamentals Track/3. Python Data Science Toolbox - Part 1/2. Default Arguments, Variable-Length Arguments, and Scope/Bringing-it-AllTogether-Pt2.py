...
# Hint
# You need to pass only 2 parameters to the function in the function header.
# The syntax for looping over the elements of args is for col_name in args.
# Call count_entries() with only 2 arguments.
# Here you'll need to call count_entries() with 3 arguments; the final 2 arguments will be the column names of interest.