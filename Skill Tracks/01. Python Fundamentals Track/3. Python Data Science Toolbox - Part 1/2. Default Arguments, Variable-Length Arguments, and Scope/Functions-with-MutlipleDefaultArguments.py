...
# To make the letters in a string object, b, upper case, do b.upper().
# Pass the string "Hey", echo=5 and intense=True to the call to shout_echo().
# Pass the string "Hey" and intense=True to the call to shout_echo().