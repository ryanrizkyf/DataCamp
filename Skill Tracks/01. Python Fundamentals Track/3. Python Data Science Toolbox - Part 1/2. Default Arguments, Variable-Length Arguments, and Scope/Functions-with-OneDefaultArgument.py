...
# you've learned to define functions with more than one parameter and then calling those functions by passing the required number of arguments. 
...
# Hint
# The recipe for defining function headers is: def function name(parameters):.
# To concatenate a string b n times, do b * n.
# Pass just the string "Hey" to the call to shout_echo().
# Pass the string "Hey" and echo=5 to the call to shout_echo().