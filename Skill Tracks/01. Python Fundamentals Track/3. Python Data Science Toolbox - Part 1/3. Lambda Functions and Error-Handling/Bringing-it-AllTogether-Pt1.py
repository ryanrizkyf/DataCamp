...
# Before practicing your new error handling skills,in this exercise, you will write a lambda function and use filter() to select retweets, that is, 
...
# Hint
# The first argument to filter() should be the lambda function and the second argument is the sequence of tweets, tweets_df['text'].
