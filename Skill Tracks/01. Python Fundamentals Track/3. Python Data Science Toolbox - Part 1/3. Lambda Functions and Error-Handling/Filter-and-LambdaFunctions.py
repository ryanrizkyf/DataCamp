...
# Your goal in this exercise is to use filter() to create, 
# from an input list of strings, a new list that contains only strings that have more than 6 characters.
...
# Hint
# The first argument to filter() should be the lambda function and the second argument is the list fellowship. 
# Pass a string to len() to get the number of characters in the string.
