...
# Hint
# The syntax for raising a ValueError is raise, followed by ValueError, followed by the error message within parentheses ().
# Call count_entries() with two arguments, tweets_df and 'lang', in that order.