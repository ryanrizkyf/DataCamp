...
# Here, you can use lambda functions to define the function that map() will use to process the object. 
...
# Hint
# The first argument to map() should be the lambda function and the second argument is the list spells.
# To convert the map object shout_spells to a list, pass it to the list() function.