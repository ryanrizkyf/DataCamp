...
# it creates a range object with an iterator that produces the values until it reaches the limit (in the example, until the value 4). 
# If range() created the actual list, calling it with a value of 10 ** 100 may not work, 
...
# Hint
# Create an iterator object by passing range(3) to iter().
# The for loop syntax is: for loop variable in iterable:. Make sure you use the correct iterable!
# Create an iterator object by passing range(10 ** 100) to iter().