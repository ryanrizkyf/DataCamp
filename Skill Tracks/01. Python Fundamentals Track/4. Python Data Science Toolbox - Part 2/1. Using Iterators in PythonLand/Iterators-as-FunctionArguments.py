...
# Hint
# Recall that range(), given a start and end value x and y respectively, produces values from x to y - 1.
# To create a list from the range object values, pass values to the call of list().
# To get the sum from the range object values, pass values to the call of sum().