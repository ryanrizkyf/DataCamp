...
# # Hint
# To generate the list of tuples, pass the call to zip() into list().
# To create the zip object, pass the three lists into a call to zip().
# To unpack a tuple in a for loop, do: for variables in iterable:. In the iterable part, be sure to use the zip object.