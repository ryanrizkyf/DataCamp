...
# Hint
# Pass the file name 'world_dev_ind.csv' to open().
# Use the range() function with a starting value of 0 and an end value of 1000 to repeat the loop body 1000 times.