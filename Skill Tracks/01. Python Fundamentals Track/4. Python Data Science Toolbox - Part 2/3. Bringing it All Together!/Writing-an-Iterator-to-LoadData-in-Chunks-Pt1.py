...
# Hint
# Pass the file 'ind_pop.csv' and a value of 10 to the keyword argument chunksize to pd.read_csv().
# Pass df_reader to a call to next(). Pass the call to next() to each of the print() calls.