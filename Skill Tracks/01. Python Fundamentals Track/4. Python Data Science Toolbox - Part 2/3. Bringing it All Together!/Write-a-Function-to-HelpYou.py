...
# To return a value x from inside a function, do: return x.
# In the call to lists2dict(), make sure to pass feature_names as the first argument and row_vals as the second.