...
# Hint
# To initialize an empty DataFrame, simply assign the call to pd.DataFrame() to data.
# Use urb_pop_reader in the iterable portion of the for loop.
# Pass df_pop_ceb as an argument to the method append().