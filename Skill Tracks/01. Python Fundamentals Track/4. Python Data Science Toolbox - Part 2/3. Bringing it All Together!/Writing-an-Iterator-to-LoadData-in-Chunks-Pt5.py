...
# You've learned a lot about processing a large dataset in chunks. 
# In this last exercise, 
# you will put all the code for processing the data into a single function so that you can reuse the code without having to rewrite the same things all over again.
...
# but the function now makes it convenient to repeat the same process for whatever file and country code you want to process and visualize!
...
# If you have enjoyed working with this data, you can continue exploring it using the pre-processed version available on Kaggle.
...
# Hint
# The syntax for function headers is: def function name(parameters):.
