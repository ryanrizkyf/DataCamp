...
# This concept of lazy evaluation is useful when you have to deal with very large datasets, 
# because it lets you generate values in an efficient manner by yielding only chunks of data at a time instead of the whole thing at once.
...
# you won't have to explicitly create generator objects in cases such as this. 
