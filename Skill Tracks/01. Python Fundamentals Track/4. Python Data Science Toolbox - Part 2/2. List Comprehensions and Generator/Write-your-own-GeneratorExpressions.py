...
# for example, you have already encountered and used generators before, without knowing it! 
...
# Hint
# Recall that generator expressions have the same syntax as list comprehensions. 
# You can use the range() function with the argument 31 to generate values from 0 to 30.
# Use print() 5 times, passing to it the call to next() with the argument result.
# You can iterate over generator objects produced from generator expressions.