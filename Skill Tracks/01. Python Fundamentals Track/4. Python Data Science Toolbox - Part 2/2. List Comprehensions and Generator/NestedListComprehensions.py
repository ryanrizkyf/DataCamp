...
# Let's push your code-writing skills a little further. 
...
# Instructions
# In the inner list comprehension - that is, 
# the output expression of the nested list comprehension - create a list of values from 0 to 4 using range(). 
# Use col as the iterator variable.
# In the iterable part of your nested list comprehension, 
# use range() to count 5 rows - that is, create a list of values from 0 to 4. 
