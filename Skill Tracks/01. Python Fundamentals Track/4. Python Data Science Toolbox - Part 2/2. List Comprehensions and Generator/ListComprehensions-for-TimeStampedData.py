...
# We won't elaborate on it much here, 
# but what you should know is that it is a data structure that you will be working with a lot of times when analyzing data from pandas DataFrames. 
...
# Hint
# To get a column with column name 'y' from a DataFrame x, do: x['y'].
# The syntax for a basic list comprehension is [output expression for iterator variable in iterable]. 
# Note here that you should extract the time from entry in the output expression and iterate over tweet_time.