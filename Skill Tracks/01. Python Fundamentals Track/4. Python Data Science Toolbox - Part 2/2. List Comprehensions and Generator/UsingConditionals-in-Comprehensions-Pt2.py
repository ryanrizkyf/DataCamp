...
# Hint
# The first part of the conditional is an if statement followed by the boolean expression for evaluating the iterator variable. 
# The second part is an else statement.