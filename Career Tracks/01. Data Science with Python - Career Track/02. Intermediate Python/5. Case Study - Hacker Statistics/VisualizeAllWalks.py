...
# you can start making interesting plots! matplotlib.pyplot is already imported as plt.
...
# Good job! You can clearly see how the different simulations of the random walk went. 
