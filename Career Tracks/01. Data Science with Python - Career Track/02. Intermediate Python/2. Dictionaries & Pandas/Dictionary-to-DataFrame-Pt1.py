...
# he DataFrame is one of Pandas' most important data structures. It's basically a way to store tabular data where you can label the rows and the columns. 
...
# Good job! Notice that the columns of cars can be of different types. 
# This was not possible with 2D Numpy arrays!