...
# This is almost double the number of the next-highest state, Hawaii. 
# If you combine new column addition, row subsetting, sorting, and column selection, you can answer lots of questions like this.