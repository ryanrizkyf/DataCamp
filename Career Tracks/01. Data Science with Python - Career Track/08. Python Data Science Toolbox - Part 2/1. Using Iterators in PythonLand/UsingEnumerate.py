...
# In this exercise, you are given a list of strings mutants, 
# and you will practice using enumerate() on it by printing out a list of tuples and unpacking the tuples using a for loop.
...
# Hint
# To generate the list, pass the call to enumerate() into list().
# To unpack a tuple in a for loop, do: for variables in iterable:.
# To change the start index to 1, you need to specify it as an argument to the start parameter of enumerate().