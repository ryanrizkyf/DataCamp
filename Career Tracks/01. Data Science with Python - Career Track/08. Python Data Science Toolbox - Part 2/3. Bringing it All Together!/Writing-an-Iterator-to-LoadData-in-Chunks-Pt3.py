...
# Starting from the code of the previous exercise, 
...
# Hint
# Recall the syntax for a basic list comprehension: [output expression for iterator variable in iterable].
# You can use any valid variable name for the iterator variable inside the list comprehension.
# Pass the values 'scatter', 'Year', and 'Total Urban Population' to each of the keyword arguments kind, x, and y in df_pop_ceb.plot(), respectively.