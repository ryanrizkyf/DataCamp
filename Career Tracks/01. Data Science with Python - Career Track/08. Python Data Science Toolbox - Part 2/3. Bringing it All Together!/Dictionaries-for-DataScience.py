...
# Hint
# Make sure that the first argument you supply to zip() is feature_names, followed by the second argument, row_vals.
# You only need to pass the zip object zipped_lists to the call to dict().