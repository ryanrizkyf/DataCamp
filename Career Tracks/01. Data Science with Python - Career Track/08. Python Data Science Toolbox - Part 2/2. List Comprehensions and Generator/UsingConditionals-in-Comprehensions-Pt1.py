...
# Recall from the video that you can apply a conditional statement to test the iterator variable by adding an if statement 
...
# Hint
# You don't have to perform any additional operations on member for the output expression. 
# You should also start the conditional with the keyword if followed by the boolean expression for evaluating the iterator variable.