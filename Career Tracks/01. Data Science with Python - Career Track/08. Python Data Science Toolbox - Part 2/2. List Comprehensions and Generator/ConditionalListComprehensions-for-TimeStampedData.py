...
# The syntax for a list comprehension with a conditional is [output expression for iterator variable in iterableif predicate expression ]. 
# Note here that you should extract the time from entry in the output expression and iterate over tweet_time, 
# as well as add a conditional expression to check for whether entry[17:19] is equal to '19' .