...
# Use merge_ordered(), again similar to before, 
# to merge gdp and sp500 use the function's ability to interpolate missing data to forward fill the missing value for returns, 
