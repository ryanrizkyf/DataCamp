# Recall the Bringing it all together exercise in the previous chapter where you did a simple Twitter analysis, 
# by developing a function that counts how many tweets are in certain languages. 
...
# Hint
# To provide an argument x with a default value y in the function header, do: x=y.
# Because 'lang' is a column name, assign it to the keyword argument col_name when calling count_entries().
# Because 'source' is a column name, assign it to the keyword argument col_name when calling count_entries().